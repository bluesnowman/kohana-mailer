...
return array(
	...
	'css'        => array('text/css'),
	'csv'        => array('text/x-comma-separated-values', 'application/vnd.ms-excel', 'text/comma-separated-values', 'text/csv', 'text/tab-separated-values'),
	...
	'plist'      => array('text/xml', 'application/xml'),
	...
	'properties' => array('text/x-java-properties', 'text/plain'), // see http://stackoverflow.com/questions/6248130/what-is-the-mime-type-for-properties-files
	...
	'scxml'      => array('application/scxml+xml', 'application/xml', 'text/xml'),
	...
	'soap'       => array('text/xml', 'application/xml'), // not a standard extension
	'spring'     => array('text/xml', 'application/xml'), // not a standard extension
	...
	'wddx'       => array('text/xml', 'application/xml'), // not a standard extension
